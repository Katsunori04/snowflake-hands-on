...
本編を始める前、または途中で構文を確認したいときに参照する補足資料です。

| 付録 | テーマ | 教材テキスト | SQL ファイル |
|---|---|---|---|
| 付録A8 | SQL の基本（SELECT〜ウィンドウ関数・DDL） | [教材を読む](sql/A8_sql_basics.md) | [A8_sql_basics.sql](sql/A8_sql_basics.sql) |
